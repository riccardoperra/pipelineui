import searchFeature from '~/store/../docs/262shots_so.png';
import editorFeature from '~/store/../docs/327shots_so.png';
import createScratchFeature from '~/store/../docs/577shots_so.png';
